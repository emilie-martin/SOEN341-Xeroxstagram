				...
				.then((response) => {
					...
					setCharLeft(() => {
						return (
							...
							?	maxChar - response.data.biography.length
							: maxChar
						)
					});
					setLoading(false);
						...
						? <div className="edit-profile">
								<form className="edit-profile-form" onSubmit={updateProfile}>
									...
									<div>
										...
										<input type="text" name="displayName" value={displayName} onChange={(e) => handleTyping(e, setDisplayName)} />
									...
									<div>
										<label>Bio</label><br />
										<textarea name="biography" className="edit-profile-textarea" value={biography} onChange={(e) => handleCharacterCountBiography(e)} />
										<div className="success-wrapper">
									...
									<div>
										...
										<input type="text" name="email" value={email} onChange={(e) => handleTyping(e, setEmail)} />
						...
						: <div className="edit-profile">
							<form className="edit-profile-form" onSubmit={updateAccount} >
								...
								<div>
										...
										<input type="date" name="birthday" value={birthday} onChange={(e) => handleTyping(e, setBirthday)} />
										<div className="success-wrapper">
